...
def table_cards(window):
    ...
    card_1_image = Image.open("card.jpg")
    ...
    # card_2_image = ImageTk.PhotoImage(Image.open("card.jpg"))
    card_2_image = Image.open("card.jpg")
    ...
    # card_3_image = ImageTk.PhotoImage(Image.open("card.jpg"))
    card_3_image = Image.open("card.jpg")
    ...
    # card_4_image = ImageTk.PhotoImage(Image.open("card.jpg"))
    card_4_image = Image.open("card.jpg")
    ...
    # card_river_image = ImageTk.PhotoImage(Image.open("card.jpg"))
    card_river_image = Image.open("card.jpg")
...
def players(window):
    ...
    player1_card_1_image = Image.open("card.jpg")
    ...
    player1_card_2_image = Image.open("card.jpg")
    ...
    player2_card_1_image = Image.open("card.jpg")
    ...
    player2_card_2_image = Image.open("card.jpg")
    ...
    player5_card_1_image = Image.open("card.jpg")
    ...
    player5_card_2_image = Image.open("card.jpg")
    ...
    player3_card_1_image = Image.open("card.jpg")
    ...
    player3_card_2_image = Image.open("card.jpg")
    ...
    player4_card_1_image = Image.open("card.jpg")
    ...
    player4_card_2_image = Image.open("card.jpg")
...
def main():
    ...
    center_name = Label(window, text = "Payer_name's turn", bg="black", fg="white", font = "Helvetica 30 bold")
